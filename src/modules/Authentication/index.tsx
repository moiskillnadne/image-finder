...
export const AuthenticationPage = () => {
  ...
  return (
    <PageContainer colorized={background}>
      <Container flex horizontalAlign="center" verticalAlign="center" customHeight={{ value: 100, metric: "%" }}>
        <div>
          <div>
          ...
          <Container flex horizontalAlign="center">
            ...
            <Link to={RoutesPath.ImageFinderPage}>
              <Button round={{ upperRight: defaultBorderRadius, lowerRight: defaultBorderRadius }}>{">"}</Button>
            </Link>
          </Container>
        </div>
      </Container>
